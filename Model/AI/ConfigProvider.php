...
namespace Cytracon\AIContentGenerator\Model\AI;
...
class ConfigProvider implements \Magento\Framework\Data\Wysiwyg\ConfigProviderInterface
{
    ...
    {
        return $this->_assetRepo->getUrl('Cytracon_AIContentGenerator/js/tiny_mce/plugins/magentowidget/editor_plugin.js');
    }
